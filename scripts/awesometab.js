function AwesomeTab(doc, openURIs) {
  let me = this;
  me.MINUTE_CUTOFF = 10;
...
AwesomeTab.prototype.showSimilarBookmarks = function(tagMap) {
  let me = this;
  let simpleTagMap = {};
  let places = [];
  ...
  places.sort(function (a,b) {
    ...
    me.builder.addToList("similar", p[0], p[1]);
  });


}

AwesomeTab.prototype.sortCountMap = function(countMap) {
  let me = this;
  let countArr = [];
...
/* naive method #1 */
AwesomeTab.prototype.constructCountMap = function(nearPlacesMap) {
  let me = this;
  let countMap = {};
...
AwesomeTab.prototype.constructVisitsMap = function(places) {
  let me = this;
...
AwesomeTab.prototype.constructNearPlacesMap = function(visitsMap) {
  let me = this;
  let nearPlacesMap = {};
...
AwesomeTab.prototype.getTagsFromPlace = function(placeId) {
  let me = this;
...
AwesomeTab.prototype.getPlacesFromTag = function(tag) {
  let me = this;
  let taggingSvc = Cc["@mozilla.org/browser/tagging-service;1"]
                   .getService(Ci.nsITaggingService);
...
AwesomeTab.prototype.buildTagMap = function(placeMap) {
  let me = this;
  let placeTagMap = {};
  let altTagMap = {};
...
function AwesomeTabBuilder(doc) {
  let me = this;
  me.utils = new AwesomeTabUtils();
  me.doc = doc;
};

AwesomeTabBuilder.prototype.enableSimilarBookmarks = function() {
  let me = this;
  me.doc.getElementById('similar-bookmarks-container').style.display = 'block';
}

AwesomeTabBuilder.prototype.enableBrowsedTogether = function() {
  let me = this;
  me.doc.getElementById('browsed-together-container').style.display = 'block';
}

AwesomeTabBuilder.prototype.addToList = function(list, placeId, extra) {
  let me = this;
  function getPlaceInfo(pid) {
    let result = me.utils.getData(["url", "title"],{"id": pid},"moz_places");
    return result.length > 0 ? {"url": result[0]["url"], "title":result[0]["title"]} : null;
